...
- 42 версионируемых Go-задач с public/hidden-тестами: 25 алгоритмических, 7 на конкурентность и 10 на ООП и ошибки;
...
- пропуск задачи по обоюдному согласию игроков без изменения счёта;
- одиночная тренировка: каталог задач, черновик на сервере и отметка «решено»;
